...
public class frmlogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("LOGIN PKKP");

        jLabel4.setBackground(new java.awt.Color(102, 0, 51));
        jLabel4.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel4.setText("                                             @Muhammad Fachruddin");
    ...
    private void okActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okActionPerformed
        ...
        try {
            ...
            String query = "SELECT * FROM user WHERE name = '" + txtUsername.getText() + "' AND password = '" + password + "'";
            System.out.println("Query: " + query);  
            ResultSet RsUser = stm.executeQuery(query);
            int baris = 0;
            while (RsUser.next()) {
                baris = RsUser.getRow();
            }
